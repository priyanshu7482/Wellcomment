    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-1/3">
      ...
      <div class="mb-4">
        ...
        <div class="flex items-center">
          ...
          <label for="gynaecology" class="text-gray-700">Sexology</label>
          <span class="ml-auto text-gray-700">₹599</span>
        </div>
      </div>
      ...
      <!-- Continue Button -->
      <button class=" bg-red-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600"><a href="QRScanner/QRCode.jsp">
              Continue</a>
      </button><button id="continueBtn" class="bg-red-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600">
    Continue
</button>
